...
// menampilkan produk yang memiliki penjualan terbanyak
$best = tampil("SELECT b.produkID,b.harga, namaproduk, GambarProduk, sum(a.qty) AS hasil FROM detail_transaksi a, produk b WHERE a.produkID = b.produkID GROUP BY a.produkID ORDER BY hasil DESC limit 3");
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="vendor/css/stylebs.css">
			...
			<?php foreach ($best as $data) { ?>
					<div class="col-md-<?= $colwidth; ?>">
						<div class="ml-5 mb-4 card w-75">
							...
							<img src="admin/uploaded_files/<?= $data['GambarProduk'] ?>" class="card-img-top" height="270">
							</a>
							<div class="card-body">
								<p><?= $data['namaproduk']; ?></p>
